...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        handlers = [
            ...
            (r"/apiv1/audiofile.search", AudioFileHandler),
            (r"/apiv1/user/create",UserHandler),
            (r"/apiv1/user/get/(.*)", UserHandler),
            (r"/apiv1/user/rm/(.*)", UserHandler),
            (r"/apiv1/user/edit/(.*)",UserHandler),
